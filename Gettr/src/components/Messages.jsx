...
import{fetchUserMessages} from '../api/MessagesApi.js';
...
<div>
  <ThemeProvider theme={theme}>
        ...
        <Grid container component={Paper} style={theme.chatSection}>
            <Grid item xs={3} style={theme.borderRight500}>
                ...
                <List>
                    ...
                    [...privateChats.keys()].map((name,index)=>(
                        <ListItem onClick={()=>setTab({...tab,"currTab":name,"id":userInfo.get(name)})} key = {index}>
                            <ListItemIcon>
            ...
            <Grid item xs={9}>
            { tab.currTab != "" && privateChats.get(tab.currTab).size > 0 &&
                ...
                <Grid container style={{padding: '20px'}}>
                    ...
                    <Grid xs={1} align="right">
                        <Fab color="primary" aria-label="add" ><SendIcon onClick={()=>console.log(userInfo)}/></Fab>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
